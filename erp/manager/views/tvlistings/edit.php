    ...
    <div class="card-block">
        ...
        <div class="form-group">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link font-2xl active" data-toggle="tab" href="#home2" role="tab" aria-controls="home" aria-expanded="true"> 日 期 选 择 </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-2xl" data-toggle="tab" href="#profile2" role="tab" aria-controls="profile" aria-expanded="false"> 周 选 择 </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-2xl" data-toggle="tab" href="#profile3" role="tab" aria-controls="profile" aria-expanded="false"> 时 间 选 择 </a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="home2" role="tabpanel" aria-expanded="true">
                    ...
                    <div class="form-group field-tvlistings-day">
                        <?=$form->field($tv,'start_time')->hiddenInput()->label(false)?>
                        <?=$form->field($tv,'end_time')->hiddenInput()->label(false)?>
                        ...
                        layui.use('laydate', function(){
                            ...
                            var start = {
                                ...
                                choose: function(datas){
                                    ...
                                    $("#tvlistings-start_time").val(datas);
                            ...
                            var end = {
                                ...
                                choose: function(datas){
                                    ...
                                    alert($("#LAY_demorange_e").val());
                                    $("#tvlistings-end_time").val(datas);
                                }
                            };
